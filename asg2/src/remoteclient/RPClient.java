...
public class RPClient {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            rpr = (IRemoteRP) ic.lookup("remotelib.IRemoteRP");  //Changed 'lookup' name from tutorial
        ...
        cout.println("I, Nash Dean and Travis Dietz, certify that this project is my work only.  " +
            ...
            switch (c) {
                ...
                case 'R':
                    ...
                    do {
                        ...
                        int n = rpr.Register(sno, cid, sid);
